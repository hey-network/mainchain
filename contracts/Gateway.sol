...
contract Gateway is ERC20Receiver, ValidatorsManagerContract {
  ...
  constructor (address _tokenAddress, address[] _validators, uint8 _threshold_num, uint8 _threshold_denom)
    public
  ...
  function withdrawERC20(uint256 amount, bytes signature)
    external
