...
contract ValidatorsManagerContract is Ownable {
  ...
  constructor (address _tokenAddress, address[] _validators, uint8 _threshold_num, uint8 _threshold_denom) public {
  ...
  modifier isVerifiedByValidator(uint256 num, bytes sig) {
